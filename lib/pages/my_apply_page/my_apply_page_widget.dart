...
import 'my_apply_page_model.dart';
export 'my_apply_page_model.dart';

class MyApplyPageWidget extends StatefulWidget {
  const MyApplyPageWidget({super.key});

  @override
  State<MyApplyPageWidget> createState() => _MyApplyPageWidgetState();
}

class _MyApplyPageWidgetState extends State<MyApplyPageWidget> {
  late MyApplyPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyApplyPageModel());
  }
        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: AuthUserStreamWidget(
              builder: (context) => StreamBuilder<List<ApplicantpageRecord>>(
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                await columnApplicantpageRecord
                                                    .reference
                                                    .delete();
                                              },
                                              text: '삭제',
